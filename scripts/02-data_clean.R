...
### following code was found at: https://stackoverflow.com/questions/42820677/ggplot-bar-plot-side-by-side-using-two-variables
...
count_data_2 |>
  ...
  scale_fill_discrete(name = "Ridership Activity", 
